...
const MESSAGES_EN = {
  ...
  'speech.master.off': 'Read this to me',
  'speech.master.on': 'Reading aloud — press to turn off',
  'speech.master.hintOff': 'New here? Press this button and the app reads each screen out loud.',
  'speech.master.hintOn': 'The app is reading each screen out loud. Press the button again to turn it off.',
  'speech.master.substitute': 'This device has no voice for the language you chose, so the app reads its own {language} translation of the same words, in a {language} voice.',
   ...
   *
   * One voice, three registers, and the split is deliberate:
   *
   *   - LUMINA NOY asks. Prompts, helper lines and the record's opening are hers: first
   *     person, short, warm. She used to speak only on the welcome screen while the screens
   *     behind it read like a form, which made the guide feel like a mascot pasted onto an
   *     instrument. She now says the same governed strings all the way through.
   *   - The reader answers. Option labels and the two record buttons are in the reader's
   *     own voice, matching `welcome.begin`, so a button is always something *they* say.
   *   - Safety and governance do not smile. `welcome.boundary`, `record.escalation`,
   *     `record.pendingReview` and `record.routineNote` keep the flat, formal register on
   *     purpose. The line that says "this is not a diagnosis" must not sound like the line
   *     that says "nice work" — rule 6 is honoured in the tone as well as in the order.
   *
   * No option was made kinder than it is honest: "Never" became "Not yet" because the app
   * does not punish an answer (see 06_함정과교훈 C4), not to flatter the reader. */
  ...
  'skinquest.L1.S1.prompt': 'An hour after washing, with nothing on yet — how does your face feel?',
  'skinquest.L1.S1.help': 'Tap whichever is closest. You can change it later.',
  'skinquest.L1.S1.tight': 'It feels tight',
  'skinquest.L1.S1.comfortable': 'It feels comfortable',
  'skinquest.L1.S1.shiny': 'It looks shiny',
  'skinquest.L1.S1.mixed': 'Different in different places',

  'skinquest.L1.S2.prompt': 'What are you most curious about today?',
  'skinquest.L1.S2.help': 'We can start wherever your eyes go first.',
  ...
  'skinquest.L2.S1.help':
    'Stinging is not the only kind of reaction — anything you noticed afterwards counts.',
  ...
  'skinquest.L2.S2.prompt': 'When in the day do you notice it most?',
  ...
  'skinquest.L3.S1.help':
    'Tell me what you actually do, not what you mean to do. Either answer is fine.',
  'skinquest.L3.S1.daily': 'Every day',
  'skinquest.L3.S1.sunny': 'On sunny days',
  'skinquest.L3.S1.rarely': 'Now and then',
  'skinquest.L3.S1.never': 'Not yet',

  'skinquest.concerns.prompt': 'Is anything catching your eye right now?',
  'skinquest.concerns.help':
    'Pick as many as you like, or none at all. This is your list, not a verdict.',
  'skinquest.concerns.none': 'Nothing right now',

  'skinquest.record.eyebrow': 'Your record',
  'skinquest.record.headline': 'Here is everything you noticed — I wrote it all down.',
  'skinquest.record.lead':
    'These are your own answers, exactly as you gave them. I have not interpreted, scored or diagnosed anything.',
  'skinquest.record.answers': 'What you told me',
  ...
  'skinquest.record.restart': 'I want to start over',
  'skinquest.record.explore': 'Take me to the lessons',
  ...
  /* ---- Ingredient hunt (QST-008 / QST-009, made playable) -----------------
   * The game asks which records the database files under a heading and marks the answer
   ...
   * The answer never depends on whether a claim is true, only on what kind of sentence it is. */
  'claim.title': 'Claim or note?',
  'claim.prompt': 'Which of these could someone else go and check?',
  'claim.bucket.observation': 'Could be checked',
  'claim.bucket.claim': 'Someone’s conclusion',
  'claim.check': 'Check my sorting',
  'claim.again': 'Try again',
  'claim.result': '{correct} of {total} sorted the way the exercise does.',
  'claim.note':
    'Sorting is about the kind of sentence, never about whether it is true. “Natural ingredients are gentler” sorts as a conclusion whether or not it is correct — it is the sort of sentence that would need evidence behind it, and this app takes no position on it.',
  'order.prompt': '{name} — {description}. Which order do these go in?',
  'order.help': 'Tap a step to place it. Tap a placed step to take it back.',
  'order.check': 'Check the order',
  'order.next': 'Another routine',
  'order.right': 'That is the order.',
  'order.notYet': 'Not this time. Here is the order:',
  'order.solved': '{solved} of {total} routines in order.',
  'order.source': 'From {id} {name} — the record is {status}.',
  'order.note':
    'The ten routine records are the only ones in the database that have been approved, which is why this screen can show an order at all. It does not explain why a step comes where it does: the approval covers the sequence, not a reason for it.',
  'compare.prompt': 'Put two families side by side and see where they differ.',
  'compare.help': 'Pick any two. Start with the acids if you are not sure.',
  'compare.left': 'On the left',
  ...
  'calendar.here': 'came',
  'calendar.away': 'did not come',
  'calendar.note': 'A missed day takes nothing away. The squares are here to be looked at, not to be owed.',
  'review.allCaughtUp': 'Nothing due today. {tracked} ingredients are being kept warm.',
  'review.title': 'Coming back',
  'review.note':
    'An ingredient you missed returns tomorrow; one you keep recognising returns less and less often. Missing a day takes nothing away.',
  'hunt.prompt': 'Find every {family} in this list.',
  'hunt.help': 'Tap the ones you think belong. Nothing is lost for a wrong guess.',
  'hunt.check': 'Check my list',
  'hunt.next': 'Another list',
  'hunt.found': 'You found {correct} of {total}.',
  'hunt.alsoWere': 'These were too:',
  'hunt.notThese': 'These belong somewhere else:',
  'hunt.learned': 'You can now recognise {learned} of {total} ingredients.',
  'hunt.sourceNote':
    'Marked against the Family column of the ingredient record, exactly as the database has it. The record is still in review, which is why this is a sorting game and not a statement about what anything does.',
  'hunt.showSource': 'Show me the record',
  'hunt.hideSource': 'Hide the record',
  'hunt.field.family': 'Family',
  'hunt.field.function': 'Primary function',
  'hunt.field.level': 'Level',
  'hunt.field.goal': 'Learning goal',
  'hunt.field.status': 'Review status',
  'hunt.field.reference': 'Reference',
  'hunt.noReference': 'No reference recorded yet',
...
const MESSAGES_KO: Partial<Record<MessageKey, string>> = {
  ...
  'speech.master.off': '소리로 읽어드릴까요?',
  'speech.master.on': '읽어드리는 중 · 누르면 꺼집니다',
  'speech.master.hintOff': '처음이시면 이 버튼을 눌러보세요. 화면의 글을 소리로 읽어드립니다.',
  'speech.master.hintOn': '지금 화면의 글을 소리로 읽어드리고 있습니다. 끄고 싶으시면 버튼을 다시 누르세요.',
  'speech.master.substitute': '이 기기에는 선택하신 언어의 음성이 없어서, 같은 내용의 {language} 번역을 {language} 음성으로 읽어드립니다.',
  'speech.listen': '듣기',
  'speech.stop': '정지',
  ...
  'skinquest.L1.S1.prompt':
    '세수하고 한 시간쯤 지났을 때, 아무것도 안 바른 얼굴은 어떤 느낌이에요?',
  'skinquest.L1.S1.help': '가장 비슷한 것을 눌러주세요. 나중에 언제든 바꿀 수 있어요.',
  'skinquest.L1.S1.tight': '당겨요',
  'skinquest.L1.S1.comfortable': '편안해요',
  'skinquest.L1.S1.shiny': '번들거려요',
  'skinquest.L1.S1.mixed': '부위마다 달라요',

  'skinquest.L1.S2.prompt': '오늘은 어디가 제일 궁금하세요?',
  'skinquest.L1.S2.help': '지금 눈이 가는 곳부터 같이 볼게요.',
  'skinquest.L1.S2.face': '얼굴',
  'skinquest.L1.S2.body': '몸',
  'skinquest.L1.S2.hair': '두피와 머리카락',

  'skinquest.L2.S1.prompt': '새로운 것을 써 보면 피부가 반응하는 편이세요?',
  'skinquest.L2.S1.help': '따가움만 반응이 아니에요. 쓰고 나서 ‘어?’ 하고 알아차린 것 전부예요.',
  'skinquest.L2.S1.never': '알아차린 적 없어요',
  'skinquest.L2.S1.sometimes': '가끔 그래요',
  'skinquest.L2.S1.often': '자주 그래요',
  'skinquest.L2.S1.unsure': '신경 써 본 적 없어요',

  'skinquest.L2.S2.prompt': '하루 중에 언제 제일 많이 느끼세요?',
  'skinquest.L2.S2.help': '가장 심했던 날 말고, 보통의 하루를 떠올려 주세요.',
  'skinquest.L2.S2.morning': '아침에',
  'skinquest.L2.S2.evening': '하루가 끝날 무렵',
  'skinquest.L2.S2.both': '둘 다요',
  'skinquest.L2.S2.varies': '날씨에 따라 달라요',

  'skinquest.L3.S1.prompt': '자외선 차단은 얼마나 자주 하세요?',
  'skinquest.L3.S1.help':
    '마음먹은 것 말고 실제로 하고 계신 대로 답해 주세요. 어느 쪽이든 괜찮아요.',
  'skinquest.L3.S1.daily': '매일 해요',
  'skinquest.L3.S1.sunny': '햇빛 강한 날에만',
  'skinquest.L3.S1.rarely': '가끔 해요',
  'skinquest.L3.S1.never': '아직 안 해요',

  'skinquest.concerns.prompt': '지금 눈에 들어오는 것이 있으면 골라 주세요.',
  'skinquest.concerns.help':
    '여러 개 고르셔도 되고, 하나도 안 고르셔도 돼요. 판정이 아니라 나의 목록이니까요.',
  'skinquest.concerns.none': '지금은 해당하는 게 없어요',

  'skinquest.record.eyebrow': '내 기록',
  'skinquest.record.headline': '오늘 보신 것, 제가 여기 다 적어뒀어요.',
  'skinquest.record.lead':
    '전부 직접 답해 주신 그대로예요. 해석하거나, 점수를 매기거나, 진단하지 않았어요.',
  'skinquest.record.answers': '이렇게 답해 주셨어요',
  ...
  'skinquest.record.restart': '처음부터 다시 할래요',
  'skinquest.record.explore': '이제 레슨 보러 갈래요',
  ...
  'claim.bucket.observation': '확인할 수 있음',
  'claim.bucket.claim': '누군가의 결론',
  'claim.check': '분류 확인',
  'claim.again': '다시 해보기',
  'claim.result': '{total}개 중 {correct}개를 같은 쪽으로 분류하셨습니다.',
  'claim.note':
    '이 분류는 문장의 종류에 대한 것이지, 그 말이 맞는지에 대한 것이 아닙니다. "천연 성분이 더 순하다"는 맞든 틀리든 결론 쪽입니다 — 근거가 있어야 할 종류의 문장이고, 이 앱은 그 내용에 대해 입장을 가지지 않습니다.',
  'order.prompt': '{name} — {description}. 어떤 순서일까요?',
  'order.help': '단계를 누르면 놓입니다. 놓은 것을 다시 누르면 빠집니다.',
  'order.check': '순서 확인',
  'order.next': '다른 루틴',
  'order.right': '맞는 순서입니다.',
  'order.notYet': '이번엔 아니네요. 순서는 이렇습니다:',
  'order.solved': '루틴 {total}개 중 {solved}개를 맞히셨습니다.',
  'order.source': '{id} {name} 기록에서 가져왔습니다 — 상태: {status}.',
  'order.note':
    '루틴 기록 10개는 이 데이터베이스에서 유일하게 승인된 것들입니다. 그래서 이 화면만 순서를 보여줄 수 있습니다. 다만 각 단계가 왜 그 자리인지는 설명하지 않습니다 — 승인된 것은 순서이지 그 이유가 아니기 때문입니다.',
  'compare.prompt': '두 계열을 나란히 놓고 어디가 다른지 보세요.',
  'compare.help': '아무 두 개나 고르세요. 모르겠으면 산(acid) 종류부터 해보세요.',
  'compare.left': '왼쪽',
  'compare.right': '오른쪽',
  'compare.count': '기록 수',
  ...
  'calendar.here': '오심',
  'calendar.away': '안 오심',
  'calendar.note': '하루 빠져도 잃는 것은 없습니다. 이 칸들은 보시라고 있는 것이지 갚으시라고 있는 게 아닙니다.',
  'review.allCaughtUp': '오늘 볼 것은 없습니다. {tracked}종을 계속 기억나게 하고 있습니다.',
  'review.title': '다시 만나기',
  'review.note':
    '놓친 성분은 내일 다시 나오고, 계속 알아보는 성분은 점점 뜸하게 나옵니다. 하루 건너뛰어도 잃는 것은 없습니다.',
  'hunt.prompt': '이 성분표에서 {family} 계열을 모두 찾아보세요.',
  'hunt.help': '해당한다고 생각하는 것을 누르세요. 틀려도 잃는 것은 없습니다.',
  'hunt.check': '확인하기',
  'hunt.next': '다른 성분표',
  'hunt.found': '{total}개 중 {correct}개를 찾으셨습니다.',
  'hunt.alsoWere': '이것들도 같은 계열입니다:',
  'hunt.notThese': '이것들은 다른 계열입니다:',
  'hunt.learned': '이제 성분 {total}종 중 {learned}종을 알아보실 수 있습니다.',
  'hunt.sourceNote':
    '데이터베이스의 계열(Family) 항목 그대로 채점했습니다. 이 기록은 아직 검수 중이라, 무엇이 어떤 효과가 있다는 이야기가 아니라 분류 게임입니다.',
  'hunt.showSource': '원본 기록 보기',
  'hunt.hideSource': '기록 접기',
  'hunt.field.family': '계열',
  'hunt.field.function': '주요 기능',
  'hunt.field.level': '난이도',
  'hunt.field.goal': '학습 목표',
  'hunt.field.status': '검수 상태',
  'hunt.field.reference': '출처',
  'hunt.noReference': '아직 출처가 기록되지 않았습니다',
...
const MESSAGES_FR: Partial<Record<MessageKey, string>> = {
  ...
  'speech.master.off': 'Lisez-moi cette page',
  'speech.master.on': 'Lecture à voix haute — appuyez pour arrêter',
  'speech.master.hintOff': "C'est votre première visite ? Appuyez sur ce bouton et l'application vous lira chaque écran à voix haute.",
  'speech.master.hintOn': "L'application lit chaque écran à voix haute. Appuyez à nouveau sur le bouton pour arrêter.",
  'speech.master.substitute': "Cet appareil n'a pas de voix dans la langue choisie ; l'application lit donc sa propre traduction en {language}, avec une voix en {language}.",
  ...
  'skinquest.L1.S1.prompt':
    'Une heure après le nettoyage, rien sur la peau — comment votre visage se sent-il ?',
  'skinquest.L1.S1.help': 'Touchez ce qui s’en rapproche le plus. Vous pourrez changer plus tard.',
  'skinquest.L1.S1.tight': 'Ça tiraille',
  'skinquest.L1.S1.comfortable': 'C’est confortable',
  'skinquest.L1.S1.shiny': 'Ça brille',
  'skinquest.L1.S1.mixed': 'Différent selon les zones',
  'skinquest.L1.S2.prompt': 'Qu’est-ce qui vous intrigue le plus aujourd’hui ?',
  'skinquest.L1.S2.help': 'On commence là où votre regard se pose en premier.',
  ...
  'skinquest.L2.S1.help':
    'Les picotements ne sont pas la seule réaction — tout ce que vous avez remarqué ensuite compte.',
  ...
  'skinquest.L2.S2.prompt': 'À quel moment de la journée le remarquez-vous le plus ?',
  ...
  'skinquest.L3.S1.help':
    'Dites-moi ce que vous faites vraiment, pas ce que vous comptez faire. Les deux réponses me vont.',
  'skinquest.L3.S1.daily': 'Tous les jours',
  'skinquest.L3.S1.sunny': 'Les jours ensoleillés',
  'skinquest.L3.S1.rarely': 'De temps en temps',
  'skinquest.L3.S1.never': 'Pas encore',
  'skinquest.concerns.prompt': 'Quelque chose attire votre regard en ce moment ?',
  'skinquest.concerns.help':
    'Choisissez-en autant que vous voulez, ou aucune. C’est votre liste, pas un verdict.',
  'skinquest.concerns.none': 'Rien pour l’instant',
  'skinquest.record.eyebrow': 'Votre relevé',
  'skinquest.record.headline': 'Voici tout ce que vous avez remarqué — j’ai tout noté.',
  'skinquest.record.lead':
    'Ce sont vos propres réponses, telles que vous les avez données. Je n’ai rien interprété, noté ni diagnostiqué.',
  'skinquest.record.answers': 'Ce que vous m’avez dit',
  ...
  'skinquest.record.restart': 'Je veux recommencer',
  'skinquest.record.explore': 'Emmenez-moi aux leçons',
  ...
  'claim.bucket.observation': 'Vérifiable',
  'claim.bucket.claim': 'Une conclusion',
  'claim.check': 'Vérifier mon tri',
  'claim.again': 'Recommencer',
  'claim.result': '{correct} sur {total} triées comme l’exercice.',
  'claim.note':
    'Le tri porte sur le type de phrase, jamais sur sa véracité. « Les ingrédients naturels sont plus doux » est une conclusion, juste ou non : c’est le genre de phrase qui demanderait des preuves, et l’application ne prend pas position.',
  'order.prompt': '{name} — {description}. Dans quel ordre ?',
  'order.help': 'Touchez une étape pour la placer. Touchez une étape placée pour la retirer.',
  'order.check': 'Vérifier l’ordre',
  'order.next': 'Une autre routine',
  'order.right': 'C’est bien l’ordre.',
  'order.notYet': 'Pas cette fois. Voici l’ordre :',
  'order.solved': '{solved} routines sur {total} remises dans l’ordre.',
  'order.source': 'D’après {id} {name} — fiche {status}.',
  'order.note':
    'Les dix fiches de routine sont les seules approuvées de la base, et c’est pourquoi cet écran peut montrer un ordre. Il n’explique pas pourquoi une étape vient là : l’approbation porte sur la séquence, pas sur une justification.',
  'compare.prompt': 'Mettez deux familles côte à côte et voyez ce qui les distingue.',
  'compare.help': 'Choisissez-en deux. Commencez par les acides si vous hésitez.',
  'compare.left': 'À gauche',
  ...
  'calendar.here': 'venue',
  'calendar.away': 'pas venue',
  'calendar.note': 'Un jour manqué ne retire rien. Ces cases sont là pour être regardées, pas pour être dues.',
  'review.allCaughtUp': 'Rien à revoir aujourd’hui. {tracked} ingrédients restent au chaud.',
  'review.title': 'Revenir dessus',
  'review.note':
    'Un ingrédient manqué revient demain ; un ingrédient que vous reconnaissez revient de moins en moins souvent. Sauter un jour ne retire rien.',
  'hunt.prompt': 'Trouvez tous les {family} dans cette liste.',
  'hunt.help': 'Touchez ceux qui vous semblent appartenir à cette famille. Une erreur ne coûte rien.',
  'hunt.check': 'Vérifier ma liste',
  'hunt.next': 'Une autre liste',
  'hunt.found': 'Vous en avez trouvé {correct} sur {total}.',
  'hunt.alsoWere': 'Ceux-ci aussi :',
  'hunt.notThese': 'Ceux-ci appartiennent ailleurs :',
  'hunt.learned': 'Vous reconnaissez maintenant {learned} ingrédients sur {total}.',
  'hunt.sourceNote':
    'Corrigé d’après la colonne Famille de la fiche, telle quelle. La fiche est encore en révision : c’est donc un jeu de tri, pas une affirmation sur ce que fait quoi que ce soit.',
  'hunt.showSource': 'Voir la fiche',
  'hunt.hideSource': 'Masquer la fiche',
  'hunt.field.family': 'Famille',
  'hunt.field.function': 'Fonction principale',
  'hunt.field.level': 'Niveau',
  'hunt.field.goal': 'Objectif d’apprentissage',
  'hunt.field.status': 'Statut de révision',
  'hunt.field.reference': 'Référence',
  'hunt.noReference': 'Aucune référence enregistrée',
...
const MESSAGES_LO: Partial<Record<MessageKey, string>> = {
  ...
  'speech.master.off': 'ອ່ານໃຫ້ຟັງແດ່',
  'speech.master.on': 'ກຳລັງອ່ານໃຫ້ຟັງ · ກົດເພື່ອປິດ',
  'speech.master.hintOff': 'ມາຄັ້ງທຳອິດບໍ? ກົດປຸ່ມນີ້ ແລ້ວແອັບຈະອ່ານຂໍ້ຄວາມໃນແຕ່ລະໜ້າໃຫ້ຟັງ.',
  'speech.master.hintOn': 'ແອັບກຳລັງອ່ານຂໍ້ຄວາມໃນແຕ່ລະໜ້າໃຫ້ຟັງ. ຖ້າຢາກປິດ ໃຫ້ກົດປຸ່ມອີກເທື່ອໜຶ່ງ.',
  'speech.master.substitute': 'ເຄື່ອງນີ້ບໍ່ມີສຽງຂອງພາສາທີ່ທ່ານເລືອກ ດັ່ງນັ້ນແອັບຈະອ່ານຄຳແປ{language}ຂອງຂໍ້ຄວາມດຽວກັນ ດ້ວຍສຽງພາສາ{language}.',
  'speech.listen': 'ຟັງ',
  'speech.stop': 'ຢຸດ',
  ...
  'skinquest.L1.S1.prompt': 'ຫຼັງລ້າງໜ້າປະມານໜຶ່ງຊົ່ວໂມງ ຍັງບໍ່ທາຫຍັງເລີຍ — ໜ້າຂອງທ່ານຮູ້ສຶກແນວໃດ?',
  'skinquest.L1.S1.help': 'ກົດຂໍ້ທີ່ໃກ້ຄຽງທີ່ສຸດໄດ້ເລີຍ ປ່ຽນພາຍຫຼັງກໍໄດ້.',
  'skinquest.L1.S1.tight': 'ຮູ້ສຶກຕຶງ',
  'skinquest.L1.S1.comfortable': 'ຮູ້ສຶກສະບາຍ',
  'skinquest.L1.S1.shiny': 'ເບິ່ງເປັນມັນ',
  'skinquest.L1.S1.mixed': 'ຕ່າງກັນຕາມບໍລິເວນ',
  'skinquest.L1.S2.prompt': 'ມື້ນີ້ທ່ານຢາກຮູ້ເລື່ອງໃດຫຼາຍທີ່ສຸດ?',
  'skinquest.L1.S2.help': 'ເລີ່ມຈາກບ່ອນທີ່ສາຍຕາທ່ານໄປເຖິງກ່ອນ ເຮົາເບິ່ງນຳກັນ.',
  ...
  'skinquest.L2.S1.help':
    'ອາການແສບບໍ່ແມ່ນປະຕິກິລິຍາຢ່າງດຽວ — ທຸກສິ່ງທີ່ທ່ານສັງເກດເຫັນຫຼັງຈາກນັ້ນກໍນັບ.',
  ...
  'skinquest.L2.S2.prompt': 'ໃນແຕ່ລະມື້ ທ່ານສັງເກດເຫັນຫຼາຍທີ່ສຸດຕອນໃດ?',
  ...
  'skinquest.L3.S1.help':
    'ບອກຂ້ອຍຕາມສິ່ງທີ່ທ່ານເຮັດແທ້ ບໍ່ແມ່ນສິ່ງທີ່ຕັ້ງໃຈຈະເຮັດ. ຕອບແນວໃດກໍບໍ່ເປັນຫຍັງ.',
  'skinquest.L3.S1.daily': 'ທຸກມື້',
  'skinquest.L3.S1.sunny': 'ມື້ທີ່ແດດແຮງ',
  'skinquest.L3.S1.rarely': 'ບາງຄັ້ງບາງຄາວ',
  'skinquest.L3.S1.never': 'ຍັງບໍ່ທັນເຮັດ',
  'skinquest.concerns.prompt': 'ຕອນນີ້ມີຫຍັງສະດຸດຕາທ່ານບໍ?',
  'skinquest.concerns.help':
    'ເລືອກໄດ້ຫຼາຍຂໍ້ ຫຼື ບໍ່ເລືອກກໍໄດ້. ນີ້ແມ່ນລາຍການຂອງທ່ານ ບໍ່ແມ່ນຄຳຕັດສິນ.',
  'skinquest.concerns.none': 'ຕອນນີ້ຍັງບໍ່ມີ',
  'skinquest.record.eyebrow': 'ບັນທຶກຂອງຂ້ອຍ',
  'skinquest.record.headline': 'ສິ່ງທີ່ທ່ານສັງເກດເຫັນມື້ນີ້ ຂ້ອຍຈົດໄວ້ໃຫ້ໝົດແລ້ວ.',
  'skinquest.record.lead':
    'ທັງໝົດນີ້ແມ່ນຄຳຕອບຂອງທ່ານເອງ ຕາມທີ່ທ່ານຕອບ. ຂ້ອຍບໍ່ໄດ້ຕີຄວາມ, ບໍ່ໄດ້ໃຫ້ຄະແນນ ແລະ ບໍ່ໄດ້ວິນິດໄສ.',
  'skinquest.record.answers': 'ສິ່ງທີ່ທ່ານບອກຂ້ອຍ',
  ...
  'skinquest.record.restart': 'ຂ້ອຍຢາກເລີ່ມໃໝ່',
  'skinquest.record.explore': 'ພາຂ້ອຍໄປຮຽນຕໍ່',
  ...
  'claim.bucket.observation': 'ກວດໄດ້',
  'claim.bucket.claim': 'ຂໍ້ສະຫຼຸບຂອງໃຜຜູ້ໜຶ່ງ',
  'claim.check': 'ກວດການຈັດແບ່ງ',
  'claim.again': 'ລອງໃໝ່',
  'claim.result': 'ຈັດຕົງກັນ {correct} ຈາກ {total} ຂໍ້.',
  'claim.note':
    'ການຈັດແບ່ງນີ້ແມ່ນກ່ຽວກັບປະເພດຂອງປະໂຫຍກ ບໍ່ແມ່ນວ່າມັນຖືກ ຫຼື ບໍ່. "ສ່ວນປະກອບທຳມະຊາດອ່ອນໂຍນກວ່າ" ຢູ່ຝ່າຍຂໍ້ສະຫຼຸບ ບໍ່ວ່າຈະຖືກ ຫຼື ບໍ່ — ເປັນປະໂຫຍກທີ່ຕ້ອງມີຫຼັກຖານ ແລະ ແອັບນີ້ບໍ່ມີຈຸດຢືນຕໍ່ເນື້ອໃນນັ້ນ.',
  'order.prompt': '{name} — {description}. ລຳດັບເປັນແນວໃດ?',
  'order.help': 'ກົດຂັ້ນຕອນເພື່ອວາງ. ກົດອັນທີ່ວາງແລ້ວເພື່ອເອົາອອກ.',
  'order.check': 'ກວດລຳດັບ',
  'order.next': 'ກິດຈະວັດອື່ນ',
  'order.right': 'ລຳດັບຖືກຕ້ອງ.',
  'order.notYet': 'ເທື່ອນີ້ຍັງບໍ່ແມ່ນ. ລຳດັບທີ່ຖືກຕ້ອງແມ່ນ:',
  'order.solved': 'ຈັດໄດ້ {solved} ຈາກ {total} ກິດຈະວັດ.',
  'order.source': 'ມາຈາກບັນທຶກ {id} {name} — ສະຖານະ {status}.',
  'order.note':
    'ບັນທຶກກິດຈະວັດ 10 ລາຍການ ແມ່ນລາຍການດຽວໃນຖານຂໍ້ມູນທີ່ໄດ້ຮັບການອະນຸມັດ ຈຶ່ງເປັນເຫດຜົນທີ່ໜ້າຈໍນີ້ສະແດງລຳດັບໄດ້. ແຕ່ບໍ່ໄດ້ອະທິບາຍວ່າເປັນຫຍັງແຕ່ລະຂັ້ນຕອນຈຶ່ງຢູ່ບ່ອນນັ້ນ — ສິ່ງທີ່ອະນຸມັດແມ່ນລຳດັບ ບໍ່ແມ່ນເຫດຜົນ.',
  'compare.prompt': 'ວາງສອງໝວດຄຽງກັນ ແລ້ວເບິ່ງວ່າຕ່າງກັນບ່ອນໃດ.',
  'compare.help': 'ເລືອກສອງອັນໃດກໍໄດ້. ຖ້າບໍ່ແນ່ໃຈ ເລີ່ມຈາກກຸ່ມກົດ (acid) ກ່ອນ.',
  'compare.left': 'ເບື້ອງຊ້າຍ',
  ...
  'calendar.here': 'ມາ',
  'calendar.away': 'ບໍ່ໄດ້ມາ',
  'calendar.note': 'ຂາດໄປມື້ໜຶ່ງກໍບໍ່ເສຍຫຍັງ. ຊ່ອງເຫຼົ່ານີ້ມີໄວ້ໃຫ້ເບິ່ງ ບໍ່ແມ່ນໜີ້ທີ່ຕ້ອງໃຊ້.',
  'review.allCaughtUp': 'ມື້ນີ້ບໍ່ມີຫຍັງຕ້ອງເບິ່ງຄືນ. ກຳລັງຮັກສາ {tracked} ລາຍການໄວ້ໃຫ້ຈື່ໄດ້.',
  'review.title': 'ກັບມາເບິ່ງຄືນ',
  'review.note':
    'ສ່ວນປະກອບທີ່ພາດຈະກັບມາມື້ອື່ນ ສ່ວນອັນທີ່ຈື່ໄດ້ແລ້ວຈະກັບມາຫ່າງຂຶ້ນເລື້ອຍໆ. ຖ້າຂ້າມມື້ໜຶ່ງກໍບໍ່ເສຍຫຍັງ.',
  'hunt.prompt': 'ຊອກຫາ {family} ທັງໝົດໃນລາຍການນີ້.',
  'hunt.help': 'ກົດເລືອກອັນທີ່ທ່ານຄິດວ່າແມ່ນ. ຖ້າຜິດກໍບໍ່ເສຍຫຍັງ.',
  'hunt.check': 'ກວດເບິ່ງ',
  'hunt.next': 'ລາຍການອື່ນ',
  'hunt.found': 'ທ່ານພົບ {correct} ຈາກ {total}.',
  'hunt.alsoWere': 'ອັນເຫຼົ່ານີ້ກໍແມ່ນຄືກັນ:',
  'hunt.notThese': 'ອັນເຫຼົ່ານີ້ຢູ່ໝວດອື່ນ:',
  'hunt.learned': 'ດຽວນີ້ທ່ານຈື່ໄດ້ {learned} ຈາກ {total} ສ່ວນປະກອບ.',
  'hunt.sourceNote':
    'ກວດຕາມຖັນໝວດ (Family) ຂອງບັນທຶກ ຕາມທີ່ມີຢູ່. ບັນທຶກຍັງຢູ່ໃນຂັ້ນກວດສອບ ຈຶ່ງເປັນເກມຈັດໝວດ ບໍ່ແມ່ນການບອກວ່າສິ່ງໃດມີຜົນແນວໃດ.',
  'hunt.showSource': 'ເບິ່ງບັນທຶກຕົ້ນສະບັບ',
  'hunt.hideSource': 'ເຊື່ອງບັນທຶກ',
  'hunt.field.family': 'ໝວດ',
  'hunt.field.function': 'ໜ້າທີ່ຫຼັກ',
  'hunt.field.level': 'ລະດັບ',
  'hunt.field.goal': 'ເປົ້າໝາຍການຮຽນ',
  'hunt.field.status': 'ສະຖານະການກວດສອບ',
  'hunt.field.reference': 'ແຫຼ່ງອ້າງອີງ',
  'hunt.noReference': 'ຍັງບໍ່ມີແຫຼ່ງອ້າງອີງ',
...
const MESSAGES_TH: Partial<Record<MessageKey, string>> = {
  ...
  'speech.master.off': 'อ่านออกเสียงให้ฟัง',
  'speech.master.on': 'กำลังอ่านออกเสียง · กดเพื่อปิด',
  'speech.master.hintOff': 'มาครั้งแรกใช่ไหม กดปุ่มนี้แล้วแอปจะอ่านข้อความในแต่ละหน้าให้ฟัง',
  'speech.master.hintOn': 'แอปกำลังอ่านข้อความในแต่ละหน้าให้ฟัง ถ้าต้องการปิด กดปุ่มอีกครั้ง',
  'speech.master.substitute': 'อุปกรณ์นี้ไม่มีเสียงของภาษาที่คุณเลือก แอปจึงอ่านคำแปล{language}ของข้อความเดียวกันด้วยเสียงภาษา{language}',
  'speech.listen': 'ฟัง',
  'speech.stop': 'หยุด',
  ...
  'skinquest.L1.S1.prompt':
    'หนึ่งชั่วโมงหลังล้างหน้า ยังไม่ได้ทาอะไรเลย ใบหน้าของคุณรู้สึกอย่างไรคะ',
  'skinquest.L1.S1.help': 'กดข้อที่ใกล้เคียงที่สุดได้เลยค่ะ เปลี่ยนภายหลังได้',
  'skinquest.L1.S1.tight': 'รู้สึกตึง',
  'skinquest.L1.S1.comfortable': 'รู้สึกสบาย',
  'skinquest.L1.S1.shiny': 'ดูมันวาว',
  'skinquest.L1.S1.mixed': 'ต่างกันตามบริเวณ',
  'skinquest.L1.S2.prompt': 'วันนี้คุณอยากรู้เรื่องไหนมากที่สุดคะ',
  'skinquest.L1.S2.help': 'เริ่มจากตรงที่สายตาคุณไปถึงก่อน เราดูไปด้วยกัน',
  'skinquest.L1.S2.face': 'ใบหน้าของฉัน',
  'skinquest.L1.S2.body': 'ร่างกายของฉัน',
  'skinquest.L1.S2.hair': 'หนังศีรษะและเส้นผม',
  'skinquest.L2.S1.prompt': 'เมื่อคุณลองของใหม่ ผิวของคุณมีปฏิกิริยาไหมคะ',
  'skinquest.L2.S1.help':
    'อาการแสบไม่ใช่ปฏิกิริยาอย่างเดียว ทุกอย่างที่คุณสังเกตเห็นหลังจากนั้นก็นับ',
  ...
  'skinquest.L2.S2.prompt': 'ในแต่ละวัน คุณสังเกตเห็นมากที่สุดตอนไหนคะ',
  ...
  'skinquest.L3.S1.prompt': 'คุณใช้การป้องกันแดดบ่อยแค่ไหนคะ',
  'skinquest.L3.S1.help': 'บอกฉันตามที่ทำจริง ไม่ใช่สิ่งที่ตั้งใจจะทำ ตอบแบบไหนก็ไม่เป็นไรค่ะ',
  'skinquest.L3.S1.daily': 'ทุกวัน',
  'skinquest.L3.S1.sunny': 'วันที่แดดแรง',
  'skinquest.L3.S1.rarely': 'นาน ๆ ครั้ง',
  'skinquest.L3.S1.never': 'ยังไม่ได้ทำ',
  'skinquest.concerns.prompt': 'ตอนนี้มีอะไรสะดุดตาคุณบ้างไหมคะ',
  'skinquest.concerns.help':
    'เลือกกี่ข้อก็ได้ หรือไม่เลือกเลยก็ได้ นี่คือรายการของคุณ ไม่ใช่คำตัดสิน',
  'skinquest.concerns.none': 'ตอนนี้ยังไม่มี',
  'skinquest.record.eyebrow': 'บันทึกของฉัน',
  'skinquest.record.headline': 'สิ่งที่คุณสังเกตเห็นวันนี้ ฉันจดไว้ให้หมดแล้วค่ะ',
  'skinquest.record.lead':
    'ทั้งหมดนี้คือคำตอบของคุณเอง ตามที่คุณตอบ ฉันไม่ได้ตีความ ไม่ได้ให้คะแนน และไม่ได้วินิจฉัย',
  'skinquest.record.answers': 'สิ่งที่คุณบอกฉัน',
  ...
  'skinquest.record.restart': 'ฉันอยากเริ่มใหม่',
  'skinquest.record.explore': 'พาฉันไปเรียนต่อ',
  ...
  'claim.bucket.observation': 'ตรวจสอบได้',
  'claim.bucket.claim': 'ข้อสรุปของใครบางคน',
  'claim.check': 'ตรวจการจัดกลุ่ม',
  'claim.again': 'ลองใหม่',
  'claim.result': 'จัดตรงกัน {correct} จาก {total} ข้อ',
  'claim.note':
    'การจัดกลุ่มนี้เกี่ยวกับประเภทของประโยค ไม่ใช่ว่าถูกหรือไม่ "ส่วนผสมจากธรรมชาติอ่อนโยนกว่า" อยู่ฝั่งข้อสรุป ไม่ว่าจะถูกหรือไม่ เป็นประโยคที่ต้องมีหลักฐาน และแอปนี้ไม่มีจุดยืนต่อเนื้อหานั้น',
  'order.prompt': '{name} — {description} ลำดับเป็นอย่างไร',
  'order.help': 'แตะขั้นตอนเพื่อวาง แตะอันที่วางแล้วเพื่อเอาออก',
  'order.check': 'ตรวจลำดับ',
  'order.next': 'กิจวัตรอื่น',
  'order.right': 'ลำดับถูกต้อง',
  'order.notYet': 'ครั้งนี้ยังไม่ใช่ ลำดับที่ถูกคือ:',
  'order.solved': 'เรียงได้ {solved} จาก {total} กิจวัตร',
  'order.source': 'จากบันทึก {id} {name} — สถานะ {status}',
  'order.note':
    'บันทึกกิจวัตร 10 รายการเป็นรายการเดียวในฐานข้อมูลที่ได้รับการอนุมัติ จึงเป็นเหตุผลที่หน้านี้แสดงลำดับได้ แต่ไม่ได้อธิบายว่าทำไมแต่ละขั้นจึงอยู่ตรงนั้น สิ่งที่อนุมัติคือลำดับ ไม่ใช่เหตุผล',
  'compare.prompt': 'วางสองหมวดเคียงกันแล้วดูว่าต่างกันตรงไหน',
  'compare.help': 'เลือกสองอันใดก็ได้ ถ้าไม่แน่ใจ เริ่มจากกลุ่มกรดก่อน',
  'compare.left': 'ด้านซ้าย',
  ...
  'calendar.here': 'มา',
  'calendar.away': 'ไม่ได้มา',
  'calendar.note': 'ขาดไปวันหนึ่งก็ไม่เสียอะไร ช่องเหล่านี้มีไว้ให้ดู ไม่ใช่หนี้ที่ต้องใช้',
  'review.allCaughtUp': 'วันนี้ไม่มีอะไรต้องทบทวน กำลังรักษา {tracked} รายการไว้ให้จำได้',
  'review.title': 'กลับมาทบทวน',
  'review.note':
    'ส่วนผสมที่พลาดจะกลับมาพรุ่งนี้ ส่วนที่จำได้แล้วจะกลับมาห่างขึ้นเรื่อย ๆ ข้ามไปวันหนึ่งก็ไม่เสียอะไร',
  'hunt.prompt': 'หา {family} ทั้งหมดในรายการนี้',
  'hunt.help': 'แตะอันที่คิดว่าใช่ ตอบผิดไม่เสียอะไร',
  'hunt.check': 'ตรวจคำตอบ',
  'hunt.next': 'รายการอื่น',
  'hunt.found': 'คุณพบ {correct} จาก {total}',
  'hunt.alsoWere': 'เหล่านี้ก็ใช่เช่นกัน:',
  'hunt.notThese': 'เหล่านี้อยู่หมวดอื่น:',
  'hunt.learned': 'ตอนนี้คุณจำส่วนผสมได้ {learned} จาก {total} ชนิด',
  'hunt.sourceNote':
    'ตรวจตามคอลัมน์หมวด (Family) ของบันทึกตามที่มีอยู่ บันทึกยังอยู่ระหว่างตรวจสอบ จึงเป็นเกมจัดหมวด ไม่ใช่การบอกว่าสิ่งใดมีผลอย่างไร',
  'hunt.showSource': 'ดูบันทึกต้นฉบับ',
  'hunt.hideSource': 'ซ่อนบันทึก',
  'hunt.field.family': 'หมวด',
  'hunt.field.function': 'หน้าที่หลัก',
  'hunt.field.level': 'ระดับ',
  'hunt.field.goal': 'เป้าหมายการเรียน',
  'hunt.field.status': 'สถานะการตรวจสอบ',
  'hunt.field.reference': 'แหล่งอ้างอิง',
  'hunt.noReference': 'ยังไม่มีแหล่งอ้างอิง',
